    ...
    <div>
      ...
      <div className="rounded-lg shadow-md p-6 overflow-x-auto">
        {loading ? (
          ...
          <table className="min-w-[600px] md:min-w-full border-collapse rounded-lg overflow-hidden shadow">
            ...
            <tbody className="bg-white text-sm text-gray-800">
              {allUser.map((user, index) => (
                ...
                >
                  ...
                  <td className="py-3 px-4 border-b border-r border-gray-200 capitalize">
                    {user.name}
                  </td>
                  <td className="py-3 px-4 border-b border-r border-gray-200">
                    {user.email}
